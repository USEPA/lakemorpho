...
lakeMajorAxisLength <- function(inLakeMorpho, pointDens, addLine = TRUE) {
  ...
  # points(lakeShorePoints)
  # lines(elpshull)
  # points(elpshull.center, col = "red")
  # lines(rbind(elpshull.center, elpshull[dist2center == min(dist2center),]))
  # lines(elpshull[dist2center == max(dist2center),])
