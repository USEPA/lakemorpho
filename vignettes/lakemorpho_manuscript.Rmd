...
<!-- Think about discussing details of the implementation in more depth --!>
...
lakeMaxLength(example_lakeMorpho, 1000)
```
...
####lakeMeanDepth	
Mean depth of a lake is calculated as the volume of the lake divided by the area.  This function requires only a `lakeMorpho` object and returns a numeric value of the mean depth.  Usage of the function is:

```{r lakeMeanDepthExample}
lakeMeadDepth(example_lakeMorpho)
```
