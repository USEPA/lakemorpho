...
In addition to these packages two external libraries, Geospatial Data Abstraction Library (GDAL) and the Geometry Engine, Open Source(GEOS), are needed and their availability to R varies by operating system [@GDAL;@GEOS]. 
